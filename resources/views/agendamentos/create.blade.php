            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                    ...
                    <form action="{{ route('agendamentos.store', $espaco->id) }}" method="POST">
                        ...
                        <button type="submit" class="w-full bg-blue-600 text-black font-bold py-3 px-4 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors">
                            SALVAR RESERVA
                        </button>
                    </form>
                </div>
