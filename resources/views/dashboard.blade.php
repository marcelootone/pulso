    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 flex flex-wrap gap-4">
                ...
                @hasrole('Gestor|Secretaria|Coordenador|Professor|Professor Educação Especial|Professor de Estudo Orientado')
                <a href="{{ route('eletivas.index') }}" class="bg-white hover:bg-gray-50 text-gray-700 border border-gray-300 font-semibold py-2 px-4 rounded shadow flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
